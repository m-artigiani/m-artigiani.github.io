...
## Published
1. Mauro Artigiani, Anja Randecker, Chandrika Sadanand, Ferrán Valdez and Gabriela Weitze-Schmithüsen: _Realizing groups as symmetries of infinite translation surfaces_. To appear in Algebraic & Geometric Topology. [arXiv](https://arxiv.org/abs/2311.00158)
1. Mauro Artigiani, Pascal Hubert and Alexandra Skripchenko: [_Renormalization for Bruin-Troubetzkoy ITMs_](https://www.aimsciences.org/article/doi/10.3934/dcds.2025127). Discrete and Continuous Dynamical Systems, **47** (2026), 519--547.  [arXiv version](https://arxiv.org/abs/2412.07928)
...
1. Mauro Artigiani: [*Octagonal continued fraction and Diagonal Changes*](https://doi.org/10.13137/2464-8728/32167), Rendiconti dell'Instituto di Matematica dell'Università di Trieste, **53** (2021), N. 9, 1--28. [arXiv version](https://arxiv.org/abs/2010.04670).
...
## Others
1. Mauro Artigiani: *Cómo aprendí a dejar de preocuparme y a amar la internacionalización del currículo*. In: Martínez, F. (Ed.). Méndez-Romero, R. (Ed.). García, C. (Ed.). Martínez, F., et al. (2024). *Conectando mundos* (1.ª ed.). Editorial Universidad del Rosario. [10.12804/urosario9789585003569](https://doi.org/10.12804/urosario9789585003569)